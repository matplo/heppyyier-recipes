...
python3 -m pip install \
    --force-reinstall \
    --target {{ prefix }} \
    "git+https://github.com/matplo/heppyyier-utils.git@main"
...
PYTHONPATH={{ prefix }} python3 -c "import heppyyier_utils; import heppyyier_utils.jewel; print('[heppyyier-utils]', heppyyier_utils.__version__)"
